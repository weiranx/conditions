...
- Provider-selectable OpenAI, Claude, or Gemini route suggestions and multi-waypoint route analysis
...
| `ai-client.js` | OpenAI/Anthropic/Gemini provider switch, ordered failover, and shared AI client wrapper |
