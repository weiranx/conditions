...
| GET | `/api/account/reports` | List generated report history for the signed-in account |
| GET | `/api/reports/shared/:shareToken` | Open a read-only generated report from its random share link |
