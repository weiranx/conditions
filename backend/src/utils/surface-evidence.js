...
const meltFreezeAnalysis = (weather, options, hasSnowCoverage) => {
  ...
  const reasons = [completeNight ? `${night.freezingHours} preceding-night ${night.freezingHours === 1 ? 'hour' : 'hours'} below freezing, ${night.freezingDegreeHours.toFixed(1)} freezing degree-hours: ${refreezeQuality} refreeze potential.` : 'The preceding night is incomplete or unavailable; refreeze quality is unknown.',
