      ...
      <main className="ssr-home" ref={revealRef}>
        ...
        <section className="ssr-h-sources" aria-labelledby="home-sources-title">
          ...
          <div className="ssr-h-source-ai" data-reveal>
            ...
            <p><strong>Optional AI synthesis</strong> Models from OpenAI, Anthropic, or Gemini turn the structured source data into briefings and follow-up answers when AI is enabled. Official provider data remains visible and authoritative.</p>
          </div>
