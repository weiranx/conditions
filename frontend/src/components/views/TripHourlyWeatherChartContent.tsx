...
import type { HourlyMetric, TripHourlyWeatherChartProps } from './TripHourlyWeatherChart';
...
interface TripHourlyWeatherChartContentProps extends TripHourlyWeatherChartProps {
  metric: HourlyMetric;
  onMetricChange: (metric: HourlyMetric) => void;
}

export function TripHourlyWeatherChartContent({
  points,
  dayLabel,
  windowLabel,
  timeStyle,
  ...
  metric,
  onMetricChange,
}: TripHourlyWeatherChartContentProps) {
