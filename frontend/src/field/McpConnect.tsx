  ...
  return <main className="mcp-connect">
    ...
    {account.loading ? <p role="status">Checking your account…</p> : !account.user ? <>
      ...
      {request ? <>
        ...
        <ul><li>Search objectives and retrieve forecasts.</li><li>Compare trip plans, departure times and multi-day forecasts.</li><li>Generate AI briefs, route analyses and satellite snow analyses. These count toward your AI and multi-day usage limits.</li><li>Read your saved reports and objective watches, including trip locations and dates.</li></ul>
