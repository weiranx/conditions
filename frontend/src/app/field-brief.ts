...
<body>
  <article class="page">
    ...
    <footer class="footer"><strong>Planning support, not a safety guarantee.</strong><span>Recheck official forecasts, access, avalanche information, and current field conditions.</span></footer>
  </article>
</body>
</html>`;
